    ...
    <div class="container flex items-center justify-center flex-1 h-full mx-auto">
        <div class="w-full max-w-lg z-10">
            <div class="leading-loose">
                <form action="{{ route('register') }}" method="post" class="max-w-sm p-10 m-auto rounded shadow-xl bg-white/25">
                    @csrf
                    ...
                    <div class="mb-2">
                        <div class=" relative ">
                            <input type="text" name="name" value="{{ old('name') }}" id="login-with-bg-name" class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="name"/>
                        </div>
                    </div>
                    <dt>メールアドレス</dt>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <div class=" relative ">
                            <input type="password" name="password_confirmation" id="login-with-bg-password" class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="password"/>
                        </div>
                    </div>
